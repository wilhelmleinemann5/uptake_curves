...
import style from './mc-pagination.scss?inline';
import tokens from '@maersk-global/mds-design-tokens/implementation/core/pagination/js/design-tokens-px.css.js';
