...
import style from './mc-step-indicator.scss?inline';
import tokens from '@maersk-global/mds-design-tokens/implementation/core/step-indicator/js/design-tokens-px.css.js';
