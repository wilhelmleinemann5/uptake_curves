...
import style from './mc-input-date.scss?inline';
import tokens from '@maersk-global/mds-design-tokens/implementation/core/input-date/js/design-tokens-px.css.js';
