...
import style from './mc-multi-select.scss?inline';
import tokens from '@maersk-global/mds-design-tokens/implementation/core/multi-select/js/design-tokens-px.css.js';
