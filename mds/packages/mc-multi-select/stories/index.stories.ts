...
export default {
  title: 'Components/Multi Select/Documentation',
  component: 'mc-multi-select',
  parameters: {
    slots,
    cssParts,
  },
...
export const Documentation = (args: Args, context: StoryContext) => {
  ...
  const code = generateCode('mc-multi-select', argTypes, args, slot);
  return html`${unsafeHTML(generateThemeSelector())}
    <div style="min-width: 300px">
      <mc-multi-select
        ...
        ?hiddenselectclearlabel="${args.hiddenselectclearlabel}"
