...
export const Background = (args: Args, context: StoryContext) => {
  return html`${unsafeHTML(generateThemeSelector())}
    ${renderComponentBanner(
      'Background colour classes',
      html`<p>
        These helper classes allow you to quickly apply a theme's <strong>background</strong> colours to an element and
        align with a
