...
export const Text = (args: Args, context: StoryContext) => {
  return html`${unsafeHTML(generateThemeSelector())}
    ${renderComponentBanner(
      'Text colour classes',
      html`<p>
        These helper classes allow you to quickly apply a theme's <strong>text</strong> colours to an element and align
        with a
