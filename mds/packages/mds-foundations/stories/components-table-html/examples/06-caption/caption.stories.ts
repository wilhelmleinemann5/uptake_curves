...
export const caption = (args: Args, context: StoryContext) => {
  return html`${unsafeHTML(generateThemeSelector())} ${renderComponentBanner('Caption', html``)} ${unsafeHTML(template)}
