...
<body class="mds">
  <div class="mds-table mds-table--footer mds-table--scrollable mds-table--vertical-lines-solid mds-table--footer-sticky mds-table--scrollable" style="height: 224px;">
    <table tabindex="0">
      <thead>
        <tr>
          <th>Name</th>
