...
<body class="mds">
  <div class="mds-table mds-table--nowrap mds-table--footer mds-table--vertical-lines-solid mds-table--scrollable" style="width: 360px;">
    <table tabindex="0">
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          <td class="mds-table__column--sticky">Madrid Maersk</td>
          <td>Shanghai</td>
        ...
        <tr>
          <td class="mds-table__column--sticky">Mary Maersk</td>
          <td>Busan</td>
        ...
        <tr>
          <td class="mds-table__column--sticky">Gerner Maersk</td>
          <td>Rotterdam</td>
        ...
        <tr>
          <td class="mds-table__column--sticky">Emma Maersk</td>
          <td>Los Angeles</td>
        ...
        <tr>
          <td class="mds-table__column--sticky">Johannes Maersk</td>
          <td>Yokohama</td>
        ...
        <tr>
          <td class="mds-table__column--sticky">Svendborg Maersk</td>
          <td>Manila</td>
        ...
        <tr>
          <td class="mds-table__column--sticky">Tove Maersk</td>
          <td>Santos</td>
