...
export const template = ` <body class="mds">
  <div class="mds-table mds-table--scrollable" style="max-width: 500px;">
    <table>
      <thead>
        <tr>
          <th>Name</th>
      ...
      <tbody>
        <tr>
          <td>Madrid Maersk</td>
          <td class="mds-table__cell--content-top">Shanghai</td>
        ...
        <tr>
          <td>Mary Maersk</td>
          <td class="mds-table__cell--content-top">Busan</td>
        ...
        <tr>
          <td>Gerner Maersk</td>
          <td class="mds-table__cell--content-top">Rotterdam</td>
        ...
        <tr>
          <td>Emma Maersk</td>
          <td class="mds-table__cell--content-top">Los Angeles</td>
        ...
        <tr>
          ...
          <td class="mds-table__cell--content-top">Yokohama</td>
        ...
        <tr>
          ...
          <td class="mds-table__cell--content-top">Manila</td>
        ...
        <tr>
          <td>Tove Maersk</td>
          <td class="mds-table__cell--content-top">Santos</td>
