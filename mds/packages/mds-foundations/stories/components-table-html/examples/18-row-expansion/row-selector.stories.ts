...
export const row_expansion = (args: Args, context: StoryContext) => {
  ...
  return html`${unsafeHTML(generateThemeSelector())}
    ${renderComponentBanner(
      'Row expansion',
      html`<p>
        It is recommended to use the table web component for row expansion. However, it is possible to wire expansion up
        manually and styles are provided when using mc-button.
      </p>`,
    )}
    <style></style>
    <body class="mds">
      <div class="mds-table mds-table--zebra-stripes-with-expand">
        <table>
          <thead>
            <tr>
