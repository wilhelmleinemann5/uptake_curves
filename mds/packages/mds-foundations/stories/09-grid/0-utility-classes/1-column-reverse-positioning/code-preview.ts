...
export const example = `<div class="mds-grid-xs-col-2-reverse mds-grid-sm-col-5-reverse">box</div>
    <div class="mds-grid-xs-col-1-reverse mds-grid-sm-col-3-reverse">box</div>`;
