...
import style from './mc-picker-item.scss?inline';
import tokens from '@maersk-global/mds-design-tokens/implementation/core/picker-item/js/design-tokens-px.css.js';
