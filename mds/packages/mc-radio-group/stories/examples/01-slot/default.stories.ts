...
const meta: Meta = {
  ...
  render: (args: Args, context: StoryContext) =>
    html`${unsafeHTML(generateThemeSelector())}
      <mc-radio-group>
        <span slot="legend"
          >Legend as HTML with custom
          <a href="https://designsystem.maersk.com/components/button/index.html">link</a></span
        >
        ...
        <mc-radio name="fruits" value="Lemon" label="Lemon"></mc-radio> </mc-radio-group
      >${renderCodePreview(preview, context)}`,
};

export default meta;
export const LegendAsSlot: StoryObj = {};
