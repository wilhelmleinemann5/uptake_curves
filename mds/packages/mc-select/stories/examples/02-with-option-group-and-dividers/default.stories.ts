  ...
  render: (args: Args, context: StoryContext) =>
    html`${unsafeHTML(generateThemeSelector())}
      <div class="story" style="max-width: 400px">
        <mc-select name="selectOne" label="Select medium item">
          <small>Numbers</small>
        ...
        <br />
        <mc-select name="selectTwo" label="Select small item" fit="small">
          <small>Numbers</small>
          <mc-option value="1">One</mc-option>
          <mc-option value="2">Two</mc-option>
          <mc-option value="3">Three</mc-option>
        ...
        <br />
        <mc-select name="selectThree" label="Select large item" fit="large">
          <small>Numbers</small>
          <mc-option value="1">One</mc-option>
          <mc-option value="2">Two</mc-option>
          <mc-option value="3">Three</mc-option>
...
export default meta;
export const WithOptionGroupAndDividers: StoryObj = {};
