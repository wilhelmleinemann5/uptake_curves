  ...
  render: (args: Args, context: StoryContext) => {
    return html`${unsafeHTML(generateThemeSelector())}
      <style>
        ...
        .input-container mc-select::part(label-container) {
          display: flex;
          justify-content: flex-end;
        }
        .input-container mc-select::part(label) {
          color: #000000;
        }
        .input-container mc-select::part(selected-option) {
          color: #000000;
        }
        .input-container mc-select::part(popover-content) {
          box-shadow: none;
          z-index: 1000;
        }
      </style>
      <div class="input-container">
        <mc-select label="Name">
